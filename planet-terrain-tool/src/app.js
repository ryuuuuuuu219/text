...
const palettes = {
  ...
  continental: { labels:["海洋地殻","大陸度","大陸地殻"], colors:["#163d61","#58a9a0","#d9c58e"] },
...
function cellColor(cell) {
  ...
  if(view==="continental") return ramp(palettes.continental.colors,c.continentalFraction);
